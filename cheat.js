...
class Dogeware {
    ...
    initGUI() {
        doge.GUI.setSetting=function(e, t) {
            ...
            ,
            doge.GUI.windowObj= {
                header: "CH33T", html:"", gen:()=>doge.getGuiHtml()
            }
        ...
        this.settings.showGuiButton&&function(e, t, s) {
            ...
            o.className="menuItem",
                ...
                a.innerHTML=e,
                n.style.backgroundImage='url("https://i.imgur.com/jjkFpnV.gif")',
                o.append(n, a),
                i.append(o),
    ...
    getGuiHtml() {
        ...
        ;
        let t='<div id="settHolder">\n<div style="font-size: 1.4em; margin: 10px;">Dogeware v4</div><div style="margin: 10px 10px 25px;">Made by <a href="https://dogeware.cheems.art/">chonker1337</a></div>';
        ...
        return t+="</table></tr>",
            ...
            i(5, ()=> {
                    e.checkbox("Show GUI button", "showGuiButton", "Disable if you don't want the dog under settings to be visible"), e.checkbox("GUI on middle mouse button", "guiOnMMB", "Makes it possible to open this menu by clicking the mouse wheel"), e.checkbox("Keybinds", "keybinds", "Turn keybinds on/off, Aimbot - Y, ESP - H"), e.checkbox("No inactivity kick", "antikick", "Disables the 'Kicked for inactivity' message (client side, but works)"), e.checkbox("Auto nuke", "autoNuke", "Automatically nukes when you are able to"), e.checkbox("Force nametags on", "fgno", "Use in custom games with disabled nametags"), e.input("Custom CSS", "customCSS", "url", "", "URL to CSS file")
                }
